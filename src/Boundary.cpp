...
InflowBoundary::InflowBoundary(std::vector<Cell *> cells, double inlet_velocity_x, double inlet_velocity_y,
    ...
    : _cells(cells), _inlet_velocity_x(inlet_velocity_x), _inlet_velocity_y(inlet_velocity_y),
      _inlet_temperature(inlet_temperature) {}
...
void OutflowBoundary::apply(Fields &field) {
    ...
    for (auto const &cell : _cells) {
        ...
        field.u(cell->i() - 1, cell->j()) =
            field.u(cell->neighbour(border_pos.at(0))->i() - 1, cell->neighbour(border_pos.at(0))->j());

        field.v(cell->i(), cell->j()) =
            field.v(cell->neighbour(border_pos.at(0))->i(), cell->neighbour(border_pos.at(0))->j());
        ...
        field.p(cell->i(), cell->j()) =
            field.p(cell->neighbour(border_pos.at(0))->i(), cell->neighbour(border_pos.at(0))->j());
    }
}
...
void MovingWallBoundary::apply(Fields &field) {
    ...
    for (auto cell : _cells) {
        ...
        // u on the top
        field.u(cell->i(), cell->j()) =
            2.0 * _wall_velocity[cell->wall_id()] - field.u(cell->i(), cell->neighbour(border_pos.at(0))->j());
        // F on the left
        field.g(cell->i(), cell->j()) = field.v(cell->i(), cell->j());
    }
}
